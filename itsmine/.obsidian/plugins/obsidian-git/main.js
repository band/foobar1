            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        this.git = src(path);
                        return [4 /*yield*/, this.git.checkIsRepo(src.CheckRepoActions.IS_REPO_ROOT)];
                    case 2:
                        isValidRepo = _a.sent();
                        if (!isValidRepo) {
